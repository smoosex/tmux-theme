...
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/theme_loading.sh --expected "${script_dir}"/tests/theme_loading_expected.txt "$@"
...
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/theme_switcher.sh --expected "${script_dir}"/tests/theme_switcher_expected.txt "$@"
